# StarExplorer
This is a demo application designed to showcase transactions using the Telegram star-based currency for a specific bot. It leverages the `typescript-telegram-bot-api` to fetch data from the `bot.getStarTransactions` method and display it in a list format.
